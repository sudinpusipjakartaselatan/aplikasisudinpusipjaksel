...
export default function AdminDashboard() {
  ...
  const resetForm = () => {
    ...
    if (activeTab === 'kegiatan') {
      ...
      setMlPetugas(''); setMlNoPolisi(''); setMlHari(''); setMlTanggal(''); setMlJamLayanan(''); setMlKecamatan(''); setMlKelurahan(''); setMlNamaLokasi(''); setMlAlamatTelepon(''); setMlJarakKeLokasi1(''); setMlJarakLokasi1Ke2(''); setMlJarakKembali(''); setMlTotalJarak(''); setMlNamaPimpinan(''); setMlNamaPIC(''); setMlImageUrl('');
    }
  };
            ...
            <div className="bg-white p-6 md:p-8 rounded-3xl shadow-xl border border-slate-100 mb-8 md:mb-12 animate-in fade-in slide-in-from-top-4 duration-500">
              ...
              <form onSubmit={handleSubmitMobileLib} className="space-y-6 md:space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Petugas</label><input type="text" value={mlPetugas} onChange={(e) => setMlPetugas(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Petugas..." /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">No. Polisi</label><input type="text" value={mlNoPolisi} onChange={(e) => setMlNoPolisi(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="B 1234 CD" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Hari</label><input type="text" value={mlHari} onChange={(e) => setMlHari(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Senin" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Tanggal</label><input type="text" value={mlTanggal} onChange={(e) => setMlTanggal(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="15 Oktober 2026" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Jam Layanan</label><input type="text" value={mlJamLayanan} onChange={(e) => setMlJamLayanan(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="09:00 - 12:00" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Kecamatan</label><input type="text" value={mlKecamatan} onChange={(e) => setMlKecamatan(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Kecamatan..." /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Kelurahan</label><input type="text" value={mlKelurahan} onChange={(e) => setMlKelurahan(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Kelurahan..." /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Nama Lokasi</label><input type="text" value={mlNamaLokasi} onChange={(e) => setMlNamaLokasi(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Nama Lokasi..." required /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Alamat dan No Telp Lokasi</label><input type="text" value={mlAlamatTelepon} onChange={(e) => setMlAlamatTelepon(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Alamat & No Telp..." /></div>
                  
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Jarak Ke Lokasi 1 (km)</label><input type="number" step="0.1" value={mlJarakKeLokasi1} onChange={(e) => setMlJarakKeLokasi1(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="0" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Jarak Lokasi 1 Ke 2 (km)</label><input type="number" step="0.1" value={mlJarakLokasi1Ke2} onChange={(e) => setMlJarakLokasi1Ke2(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="0" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Jarak Kembali (km)</label><input type="number" step="0.1" value={mlJarakKembali} onChange={(e) => setMlJarakKembali(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="0" /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Total Jarak Tempuh</label><input type="number" step="0.1" value={mlTotalJarak} onChange={(e) => setMlTotalJarak(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="0" /></div>
                  
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Nama Pimpinan Instansi</label><input type="text" value={mlNamaPimpinan} onChange={(e) => setMlNamaPimpinan(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="Pimpinan..." /></div>
                  <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Nama dan Nomor PIC</label><input type="text" value={mlNamaPIC} onChange={(e) => setMlNamaPIC(e.target.value)} className="w-full px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="PIC..." /></div>
                </div>
                <div><label className="block text-sm font-bold text-slate-700 mb-2.5">Tautan Gambar Armada (Kosongkan untuk Default)</label><div className="flex flex-col sm:flex-row gap-4"><input type="text" value={mlImageUrl} onChange={(e) => setMlImageUrl(e.target.value)} className="flex-1 px-4 md:px-5 py-3 md:py-4 rounded-2xl border border-slate-200 focus:outline-none focus:ring-4 focus:ring-primary/5 focus:border-primary transition-all text-slate-600 font-medium" placeholder="https://..." /><div className="w-14 h-14 rounded-2xl border-2 border-dashed border-slate-200 flex items-center justify-center shrink-0 overflow-hidden bg-slate-50">{mlImageUrl ? <img src={mlImageUrl} alt="Preview" className="w-full h-full object-cover" /> : <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-6 h-6 text-slate-300"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-1.1 0-2 .9-2 2v8c0 .6.4 1 1 1h2m-6 0h6m-14 0h6m-14 0H3v-8h16m-4 8a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm-10 0a2 2 0 1 0 0-4 2 2 0 0 0 0 4z" /></svg>}</div></div></div>
              ...
              <table className="w-full text-left min-w-[600px]">
                <thead className="bg-slate-50 border-y border-slate-200">
                  {activeTab === 'kegiatan' ? (
                    ...
                    <tr>
                      <th className="px-5 md:px-6 py-4 text-xs md:text-sm font-bold text-slate-600 uppercase tracking-wide">Detail Lokasi & Waktu</th>
                      <th className="px-5 md:px-6 py-4 text-xs md:text-sm font-bold text-slate-600 uppercase tracking-wide">Detail Operasional</th>
                      <th className="px-5 md:px-6 py-4 text-xs md:text-sm font-bold text-slate-600 uppercase tracking-wide">Detail Jarak Tempuh</th>
                      <th className="px-5 md:px-6 py-4 text-xs md:text-sm font-bold text-slate-600 uppercase tracking-wide text-right">Kelola</th>
                    </tr>
                  )}
                </thead>
                    ...
                    <tr key={ml.id} className="hover:bg-slate-50 transition-colors group">
                      <td className="px-5 md:px-6 py-4 md:py-5">
                        <div className="flex flex-col items-center gap-2">
                          <div className="w-16 h-16 md:w-20 md:h-20 rounded-xl bg-slate-100 overflow-hidden shadow-sm flex items-center justify-center border border-slate-200">
                            {ml.imageUrl ? (
                              <img src={ml.imageUrl} alt="" className="w-full h-full object-cover" />
                            ) : (
                              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-8 h-8 text-slate-400"><path d="M19 17h2c.6 0 1-.4 1-1v-3c0-.9-.7-1.7-1.5-1.9C18.7 10.6 16 10 16 10s-1.3-1.4-2.2-2.3c-.5-.4-1.1-.7-1.8-.7H5c-1.1 0-2 .9-2 2v8c0 .6.4 1 1 1h2" /><circle cx="7" cy="17" r="2" /><path d="M9 17h6" /><circle cx="17" cy="17" r="2" /></svg>
                            )}
                          </div>
                        </div>
                      </td>
                      <td className="px-5 md:px-6 py-4 md:py-5 align-top pt-5 min-w-[250px]">
                        <div className="flex flex-col gap-2">
                          <div>
                            <span className="font-bold text-slate-800 text-sm md:text-base leading-tight block">{ml.namaLokasi || ml.title}</span>
                            <span className="text-xs text-slate-500 block mt-0.5">{ml.alamatTelepon || ml.description}</span>
                            <span className="text-xs font-semibold text-slate-600 block mt-0.5">{ml.kelurahan || ml.location} {ml.kecamatan ? `- ${ml.kecamatan}` : ''}</span>
                          </div>
                          <div className="bg-slate-50 p-2 rounded-lg border border-slate-100 mt-1">
                            <span className="text-xs font-bold text-slate-700 block">{ml.hari ? `${ml.hari}, ` : ''}{ml.tanggal || ml.date}</span>
                            <span className="text-xs text-slate-500 block">{ml.jamLayanan || ml.time}</span>
                          </div>
                        </div>
                      </td>
                      <td className="px-5 md:px-6 py-4 md:py-5 align-top pt-5 min-w-[200px]">
                        <div className="flex flex-col gap-2 text-xs">
                          <div className="grid grid-cols-[80px_1fr] gap-x-2">
                            <span className="text-slate-400">Petugas</span>
                            <span className="font-semibold text-slate-700">{ml.petugas || '-'}</span>
                            <span className="text-slate-400">No. Polisi</span>
                            <span className="font-semibold text-slate-700">{ml.noPolisi || '-'}</span>
                          </div>
                          <div className="border-t border-slate-100 pt-2 grid grid-cols-[80px_1fr] gap-x-2">
                            <span className="text-slate-400">Instansi</span>
                            <span className="font-semibold text-slate-700">{ml.namaPimpinan || '-'}</span>
                            <span className="text-slate-400">PIC</span>
                            <span className="font-semibold text-slate-700">{ml.namaPIC || '-'}</span>
                          </div>
                        </div>
                      </td>
                      <td className="px-5 md:px-6 py-4 md:py-5 align-top pt-5 min-w-[220px]">
                        <div className="flex flex-col gap-1.5 text-xs">
                          <div className="flex justify-between items-center border-b border-slate-50 pb-1">
                            <span className="text-slate-500">Ktr &rarr; Lokasi 1</span>
                            <span className="font-bold text-slate-700">{ml.jarakKeLokasi1 ? `${ml.jarakKeLokasi1} km` : '-'}</span>
                          </div>
                          <div className="flex justify-between items-center border-b border-slate-50 pb-1">
                            <span className="text-slate-500">Lok 1 &rarr; Lok 2</span>
                            <span className="font-bold text-slate-700">{ml.jarakLokasi1Ke2 ? `${ml.jarakLokasi1Ke2} km` : '-'}</span>
                          </div>
                          <div className="flex justify-between items-center border-b border-slate-50 pb-1">
                            <span className="text-slate-500">Lok 2 &rarr; Ktr</span>
                            <span className="font-bold text-slate-700">{ml.jarakKembali ? `${ml.jarakKembali} km` : '-'}</span>
                          </div>
                          <div className="flex justify-between items-center pt-1">
                            <span className="text-slate-600 font-bold">Total Jarak</span>
                            <span className="font-black text-primary">{ml.totalJarak ? `${ml.totalJarak} km` : '-'}</span>
                          </div>
                        </div>
                      </td>
                      <td className="px-5 md:px-6 py-4 md:py-5 align-middle text-right">
